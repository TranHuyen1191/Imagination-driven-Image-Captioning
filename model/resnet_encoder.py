...
class ResnetEncoder(nn.Module):
    ...
    def __call__(self, images):
        ...
        """
        out = self.resnet(images) # (B, F, ceil(image_size/32), ceil(image_size/32))  #torch.Size([8, 512, 7, 7])
        ...
        if self.drop > 0: # convolutional-like output
            out = out.permute(0, 2, 3, 1)      # bring feature-dim last.  torch.Size([8, 224, 224, 512])
